...
pub fn allEntries() []const VerificationEntry {
    return &.{
        ...
        .{ .symbol = "recursive_mutex4lockEv", .expected = .{ .handled = 0 } },
        .{ .symbol = "recursive_mutex6unlockEv", .expected = .{ .handled = 0 } },
        .{ .symbol = "recursive_mutexD1Ev", .expected = .{ .handled = 0 } },
        .{ .symbol = "recursive_mutexD2Ev", .expected = .{ .handled = 0 } },
