...
pub const MutationSlot = types.MutationSlot;
pub const MutationCapture = types.MutationCapture;
pub const max_subobject_slots = types.max_subobject_slots;
pub const max_mutation_slots = types.max_mutation_slots;
