...
pub const canonical_guest_time = @import("canonical_guest_time.zig");
...
pub const CanonicalGuestClock = canonical_guest_time.Clock;
pub const CanonicalGuestScalar = canonical_guest_time.Scalar;
pub const GuestTimeoutInput = canonical_guest_time.TimeoutInput;
pub const GuestTimeoutKind = canonical_guest_time.TimeoutKind;
pub const GuestWaitState = canonical_guest_time.WaitState;
pub const GuestWaitRecord = canonical_guest_time.WaitRecord;
pub const GuestObjectLedger = canonical_guest_time.ObjectLedger;
pub const GuestSchedulerBridge = canonical_guest_time.SchedulerBridge;
pub const GuestWaitReplay = canonical_guest_time.WaitReplay;
