...
const host_gpu_callback_contract = @import("xenia_host_gpu_callback_contract");
...
const all_contracts = [_]ContractCheck{
    ...
    .{ .name = "host-gpu-callback-contract", .checkFn = host_gpu_callback_contract.contractIsWellFormed },
