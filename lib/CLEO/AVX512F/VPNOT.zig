...
pub const meta = types.InstructionMeta{
    .name = "VPNOT",
    .family = "COMPLEMENT",
    .source_path = "ISA/x86/COMPLEMENT/VPNOT.inc",
...
pub fn executeMasked(comptime bits: usize, merge: wide.Wide(bits), src: wide.Wide(bits), mask: u64, mode: wide.MaskMode, features: types.FeatureSet) types.SafetyError!wide.Wide(bits) {
