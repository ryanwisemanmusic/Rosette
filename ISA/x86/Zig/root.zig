...
pub const tables = blk: {
    ...
    break :blk [_]InstructionTable{
        ...
        entry(down_convert_vpmovdb.family, down_convert_vpmovdb.path, down_convert_vpmovdb.source),
        entry(down_convert_vpmovsdb.family, down_convert_vpmovsdb.path, down_convert_vpmovsdb.source),
        entry(down_convert_vpmovusdb.family, down_convert_vpmovusdb.path, down_convert_vpmovusdb.source),
        entry(down_convert_vpmovdw.family, down_convert_vpmovdw.path, down_convert_vpmovdw.source),
        entry(down_convert_vpmovsdw.family, down_convert_vpmovsdw.path, down_convert_vpmovsdw.source),
        entry(down_convert_vpmovusdw.family, down_convert_vpmovusdw.path, down_convert_vpmovusdw.source),
        entry(down_convert_vpmovqb.family, down_convert_vpmovqb.path, down_convert_vpmovqb.source),
        entry(down_convert_vpmovsqb.family, down_convert_vpmovsqb.path, down_convert_vpmovsqb.source),
        entry(down_convert_vpmovusqb.family, down_convert_vpmovusqb.path, down_convert_vpmovusqb.source),
        entry(down_convert_vpmovqd.family, down_convert_vpmovqd.path, down_convert_vpmovqd.source),
        entry(down_convert_vpmovsqd.family, down_convert_vpmovsqd.path, down_convert_vpmovsqd.source),
        entry(down_convert_vpmovusqd.family, down_convert_vpmovusqd.path, down_convert_vpmovusqd.source),
        entry(down_convert_vpmovqw.family, down_convert_vpmovqw.path, down_convert_vpmovqw.source),
        entry(down_convert_vpmovsqw.family, down_convert_vpmovsqw.path, down_convert_vpmovsqw.source),
        entry(down_convert_vpmovusqw.family, down_convert_vpmovusqw.path, down_convert_vpmovusqw.source),
        entry(down_convert_vpmovwb.family, down_convert_vpmovwb.path, down_convert_vpmovwb.source),
        entry(down_convert_vpmovswb.family, down_convert_vpmovswb.path, down_convert_vpmovswb.source),
        entry(down_convert_vpmovuswb.family, down_convert_vpmovuswb.path, down_convert_vpmovuswb.source),
        ...
        entry(fused_vfmadd132pd.family, fused_vfmadd132pd.path, fused_vfmadd132pd.source),
        entry(fused_vfmadd132ph.family, fused_vfmadd132ph.path, fused_vfmadd132ph.source),
        entry(fused_vfmadd132ps.family, fused_vfmadd132ps.path, fused_vfmadd132ps.source),
        entry(fused_vfmadd132sd.family, fused_vfmadd132sd.path, fused_vfmadd132sd.source),
        entry(fused_vfmadd132sh.family, fused_vfmadd132sh.path, fused_vfmadd132sh.source),
        entry(fused_vfmadd132ss.family, fused_vfmadd132ss.path, fused_vfmadd132ss.source),
        entry(fused_vfmadd213pd.family, fused_vfmadd213pd.path, fused_vfmadd213pd.source),
        entry(fused_vfmadd213ph.family, fused_vfmadd213ph.path, fused_vfmadd213ph.source),
        entry(fused_vfmadd213ps.family, fused_vfmadd213ps.path, fused_vfmadd213ps.source),
        entry(fused_vfmadd213sd.family, fused_vfmadd213sd.path, fused_vfmadd213sd.source),
        entry(fused_vfmadd213sh.family, fused_vfmadd213sh.path, fused_vfmadd213sh.source),
        entry(fused_vfmadd213ss.family, fused_vfmadd213ss.path, fused_vfmadd213ss.source),
        entry(fused_vfmadd231pd.family, fused_vfmadd231pd.path, fused_vfmadd231pd.source),
        entry(fused_vfmadd231ph.family, fused_vfmadd231ph.path, fused_vfmadd231ph.source),
        entry(fused_vfmadd231ps.family, fused_vfmadd231ps.path, fused_vfmadd231ps.source),
        entry(fused_vfmadd231sd.family, fused_vfmadd231sd.path, fused_vfmadd231sd.source),
        entry(fused_vfmadd231sh.family, fused_vfmadd231sh.path, fused_vfmadd231sh.source),
        entry(fused_vfmadd231ss.family, fused_vfmadd231ss.path, fused_vfmadd231ss.source),
        entry(fused_vfmaddrnd231pd.family, fused_vfmaddrnd231pd.path, fused_vfmaddrnd231pd.source),
        entry(fused_vfmaddsub132pd.family, fused_vfmaddsub132pd.path, fused_vfmaddsub132pd.source),
        entry(fused_vfmaddsub132ph.family, fused_vfmaddsub132ph.path, fused_vfmaddsub132ph.source),
        entry(fused_vfmaddsub132ps.family, fused_vfmaddsub132ps.path, fused_vfmaddsub132ps.source),
        entry(fused_vfmaddsub213pd.family, fused_vfmaddsub213pd.path, fused_vfmaddsub213pd.source),
        entry(fused_vfmaddsub213ph.family, fused_vfmaddsub213ph.path, fused_vfmaddsub213ph.source),
        entry(fused_vfmaddsub213ps.family, fused_vfmaddsub213ps.path, fused_vfmaddsub213ps.source),
        entry(fused_vfmaddsub231pd.family, fused_vfmaddsub231pd.path, fused_vfmaddsub231pd.source),
        entry(fused_vfmaddsub231ph.family, fused_vfmaddsub231ph.path, fused_vfmaddsub231ph.source),
        entry(fused_vfmaddsub231ps.family, fused_vfmaddsub231ps.path, fused_vfmaddsub231ps.source),
        entry(fused_vfmsub132pd.family, fused_vfmsub132pd.path, fused_vfmsub132pd.source),
        entry(fused_vfmsub132ph.family, fused_vfmsub132ph.path, fused_vfmsub132ph.source),
        entry(fused_vfmsub132ps.family, fused_vfmsub132ps.path, fused_vfmsub132ps.source),
        entry(fused_vfmsub132sd.family, fused_vfmsub132sd.path, fused_vfmsub132sd.source),
        entry(fused_vfmsub132sh.family, fused_vfmsub132sh.path, fused_vfmsub132sh.source),
        entry(fused_vfmsub132ss.family, fused_vfmsub132ss.path, fused_vfmsub132ss.source),
        entry(fused_vfmsub213pd.family, fused_vfmsub213pd.path, fused_vfmsub213pd.source),
        entry(fused_vfmsub213ph.family, fused_vfmsub213ph.path, fused_vfmsub213ph.source),
        entry(fused_vfmsub213ps.family, fused_vfmsub213ps.path, fused_vfmsub213ps.source),
        entry(fused_vfmsub213sd.family, fused_vfmsub213sd.path, fused_vfmsub213sd.source),
        entry(fused_vfmsub213sh.family, fused_vfmsub213sh.path, fused_vfmsub213sh.source),
        entry(fused_vfmsub213ss.family, fused_vfmsub213ss.path, fused_vfmsub213ss.source),
        entry(fused_vfmsub231pd.family, fused_vfmsub231pd.path, fused_vfmsub231pd.source),
        entry(fused_vfmsub231ph.family, fused_vfmsub231ph.path, fused_vfmsub231ph.source),
        entry(fused_vfmsub231ps.family, fused_vfmsub231ps.path, fused_vfmsub231ps.source),
        entry(fused_vfmsub231sd.family, fused_vfmsub231sd.path, fused_vfmsub231sd.source),
        entry(fused_vfmsub231sh.family, fused_vfmsub231sh.path, fused_vfmsub231sh.source),
        entry(fused_vfmsub231ss.family, fused_vfmsub231ss.path, fused_vfmsub231ss.source),
        entry(fused_vfmsubadd132pd.family, fused_vfmsubadd132pd.path, fused_vfmsubadd132pd.source),
        entry(fused_vfmsubadd132ph.family, fused_vfmsubadd132ph.path, fused_vfmsubadd132ph.source),
        entry(fused_vfmsubadd132ps.family, fused_vfmsubadd132ps.path, fused_vfmsubadd132ps.source),
        entry(fused_vfmsubadd213pd.family, fused_vfmsubadd213pd.path, fused_vfmsubadd213pd.source),
        entry(fused_vfmsubadd213ph.family, fused_vfmsubadd213ph.path, fused_vfmsubadd213ph.source),
        entry(fused_vfmsubadd213ps.family, fused_vfmsubadd213ps.path, fused_vfmsubadd213ps.source),
        entry(fused_vfmsubadd231pd.family, fused_vfmsubadd231pd.path, fused_vfmsubadd231pd.source),
        entry(fused_vfmsubadd231ph.family, fused_vfmsubadd231ph.path, fused_vfmsubadd231ph.source),
        entry(fused_vfmsubadd231ps.family, fused_vfmsubadd231ps.path, fused_vfmsubadd231ps.source),
        entry(fused_vfnmadd132pd.family, fused_vfnmadd132pd.path, fused_vfnmadd132pd.source),
        entry(fused_vfnmadd132ph.family, fused_vfnmadd132ph.path, fused_vfnmadd132ph.source),
        entry(fused_vfnmadd132ps.family, fused_vfnmadd132ps.path, fused_vfnmadd132ps.source),
        entry(fused_vfnmadd132sd.family, fused_vfnmadd132sd.path, fused_vfnmadd132sd.source),
        entry(fused_vfnmadd132sh.family, fused_vfnmadd132sh.path, fused_vfnmadd132sh.source),
        entry(fused_vfnmadd132ss.family, fused_vfnmadd132ss.path, fused_vfnmadd132ss.source),
        entry(fused_vfnmadd213pd.family, fused_vfnmadd213pd.path, fused_vfnmadd213pd.source),
        entry(fused_vfnmadd213ph.family, fused_vfnmadd213ph.path, fused_vfnmadd213ph.source),
        entry(fused_vfnmadd213ps.family, fused_vfnmadd213ps.path, fused_vfnmadd213ps.source),
        entry(fused_vfnmadd213sd.family, fused_vfnmadd213sd.path, fused_vfnmadd213sd.source),
        entry(fused_vfnmadd213sh.family, fused_vfnmadd213sh.path, fused_vfnmadd213sh.source),
        entry(fused_vfnmadd213ss.family, fused_vfnmadd213ss.path, fused_vfnmadd213ss.source),
        entry(fused_vfnmadd231pd.family, fused_vfnmadd231pd.path, fused_vfnmadd231pd.source),
        entry(fused_vfnmadd231ph.family, fused_vfnmadd231ph.path, fused_vfnmadd231ph.source),
        entry(fused_vfnmadd231ps.family, fused_vfnmadd231ps.path, fused_vfnmadd231ps.source),
        entry(fused_vfnmadd231sd.family, fused_vfnmadd231sd.path, fused_vfnmadd231sd.source),
        entry(fused_vfnmadd231sh.family, fused_vfnmadd231sh.path, fused_vfnmadd231sh.source),
        entry(fused_vfnmadd231ss.family, fused_vfnmadd231ss.path, fused_vfnmadd231ss.source),
        entry(fused_vfnmsub132pd.family, fused_vfnmsub132pd.path, fused_vfnmsub132pd.source),
        entry(fused_vfnmsub132ph.family, fused_vfnmsub132ph.path, fused_vfnmsub132ph.source),
        entry(fused_vfnmsub132ps.family, fused_vfnmsub132ps.path, fused_vfnmsub132ps.source),
        entry(fused_vfnmsub132sd.family, fused_vfnmsub132sd.path, fused_vfnmsub132sd.source),
        entry(fused_vfnmsub132sh.family, fused_vfnmsub132sh.path, fused_vfnmsub132sh.source),
        entry(fused_vfnmsub132ss.family, fused_vfnmsub132ss.path, fused_vfnmsub132ss.source),
        entry(fused_vfnmsub213pd.family, fused_vfnmsub213pd.path, fused_vfnmsub213pd.source),
        entry(fused_vfnmsub213ph.family, fused_vfnmsub213ph.path, fused_vfnmsub213ph.source),
        entry(fused_vfnmsub213ps.family, fused_vfnmsub213ps.path, fused_vfnmsub213ps.source),
        entry(fused_vfnmsub213sd.family, fused_vfnmsub213sd.path, fused_vfnmsub213sd.source),
        entry(fused_vfnmsub213sh.family, fused_vfnmsub213sh.path, fused_vfnmsub213sh.source),
        entry(fused_vfnmsub213ss.family, fused_vfnmsub213ss.path, fused_vfnmsub213ss.source),
        entry(fused_vfnmsub231pd.family, fused_vfnmsub231pd.path, fused_vfnmsub231pd.source),
        entry(fused_vfnmsub231ph.family, fused_vfnmsub231ph.path, fused_vfnmsub231ph.source),
        entry(fused_vfnmsub231ps.family, fused_vfnmsub231ps.path, fused_vfnmsub231ps.source),
        entry(fused_vfnmsub231sd.family, fused_vfnmsub231sd.path, fused_vfnmsub231sd.source),
        entry(fused_vfnmsub231sh.family, fused_vfnmsub231sh.path, fused_vfnmsub231sh.source),
        entry(fused_vfnmsub231ss.family, fused_vfnmsub231ss.path, fused_vfnmsub231ss.source),
        ...
        entry(test_ftst.family, test_ftst.path, test_ftst.source),
        entry(test_ktestw.family, test_ktestw.path, test_ktestw.source),
        entry(test_ktestb.family, test_ktestb.path, test_ktestb.source),
        entry(test_ktestq.family, test_ktestq.path, test_ktestq.source),
        entry(test_ktestd.family, test_ktestd.path, test_ktestd.source),
        entry(test_ptest.family, test_ptest.path, test_ptest.source),
        entry(test_vfpclasspd.family, test_vfpclasspd.path, test_vfpclasspd.source),
        entry(test_vfpclassph.family, test_vfpclassph.path, test_vfpclassph.source),
        entry(test_vfpclassps.family, test_vfpclassps.path, test_vfpclassps.source),
        entry(test_vfpclasssd.family, test_vfpclasssd.path, test_vfpclasssd.source),
        entry(test_vfpclasssh.family, test_vfpclasssh.path, test_vfpclasssh.source),
        entry(test_vfpclassss.family, test_vfpclassss.path, test_vfpclassss.source),
        entry(test_vtestpd.family, test_vtestpd.path, test_vtestpd.source),
        entry(test_vtestps.family, test_vtestps.path, test_vtestps.source),
        entry(test_xtest.family, test_xtest.path, test_xtest.source),
        entry(unpack_kunpckbw.family, unpack_kunpckbw.path, unpack_kunpckbw.source),
        entry(unpack_kunpckwd.family, unpack_kunpckwd.path, unpack_kunpckwd.source),
        entry(unpack_kunpckdq.family, unpack_kunpckdq.path, unpack_kunpckdq.source),
        entry(unpack_punpckhbw.family, unpack_punpckhbw.path, unpack_punpckhbw.source),
        entry(unpack_punpckhwd.family, unpack_punpckhwd.path, unpack_punpckhwd.source),
        entry(unpack_punpckhdq.family, unpack_punpckhdq.path, unpack_punpckhdq.source),
        entry(unpack_punpckhqdq.family, unpack_punpckhqdq.path, unpack_punpckhqdq.source),
        entry(unpack_punpcklbw.family, unpack_punpcklbw.path, unpack_punpcklbw.source),
        entry(unpack_punpcklwd.family, unpack_punpcklwd.path, unpack_punpcklwd.source),
        entry(unpack_punpckldq.family, unpack_punpckldq.path, unpack_punpckldq.source),
        entry(unpack_punpcklqdq.family, unpack_punpcklqdq.path, unpack_punpcklqdq.source),
        entry(unpack_unpckhpd.family, unpack_unpckhpd.path, unpack_unpckhpd.source),
        entry(unpack_unpckhps.family, unpack_unpckhps.path, unpack_unpckhps.source),
        entry(unpack_unpcklpd.family, unpack_unpcklpd.path, unpack_unpcklpd.source),
        entry(unpack_unpcklps.family, unpack_unpcklps.path, unpack_unpcklps.source),
        ...
        entry(store_fbstp.family, store_fbstp.path, store_fbstp.source),
        entry(store_fist.family, store_fist.path, store_fist.source),
        entry(store_fistp.family, store_fistp.path, store_fistp.source),
        entry(store_fisttp.family, store_fisttp.path, store_fisttp.source),
        entry(store_fst.family, store_fst.path, store_fst.source),
        entry(store_fstcw.family, store_fstcw.path, store_fstcw.source),
        entry(store_fstenv.family, store_fstenv.path, store_fstenv.source),
        entry(store_fstp.family, store_fstp.path, store_fstp.source),
        entry(store_fstsw.family, store_fstsw.path, store_fstsw.source),
        entry(store_maskmovdqu.family, store_maskmovdqu.path, store_maskmovdqu.source),
        entry(store_maskmovq.family, store_maskmovq.path, store_maskmovq.source),
        entry(store_sahf.family, store_sahf.path, store_sahf.source),
        entry(store_sfence.family, store_sfence.path, store_sfence.source),
        entry(store_sgdt.family, store_sgdt.path, store_sgdt.source),
        entry(store_sldt.family, store_sldt.path, store_sldt.source),
        entry(store_smsw.family, store_smsw.path, store_smsw.source),
        entry(store_stmxcsr.family, store_stmxcsr.path, store_stmxcsr.source),
        entry(store_stos.family, store_stos.path, store_stos.source),
        entry(store_str.family, store_str.path, store_str.source),
        entry(store_sttilecfg.family, store_sttilecfg.path, store_sttilecfg.source),
        entry(store_tilestored.family, store_tilestored.path, store_tilestored.source),
        entry(store_vcompresspd.family, store_vcompresspd.path, store_vcompresspd.source),
        entry(store_vcompressps.family, store_vcompressps.path, store_vcompressps.source),
        entry(store_vpcompressb.family, store_vpcompressb.path, store_vpcompressb.source),
        entry(store_vpcompressd.family, store_vpcompressd.path, store_vpcompressd.source),
        entry(store_vpcompressq.family, store_vpcompressq.path, store_vpcompressq.source),
        entry(store_vpcompressw.family, store_vpcompressw.path, store_vpcompressw.source),
        ...
        entry(pack_packsswb.family, pack_packsswb.path, pack_packsswb.source),
        entry(pack_packssdw.family, pack_packssdw.path, pack_packssdw.source),
        entry(pack_packusdw.family, pack_packusdw.path, pack_packusdw.source),
        entry(pack_packuswb.family, pack_packuswb.path, pack_packuswb.source),
        entry(pack_palignr.family, pack_palignr.path, pack_palignr.source),
        entry(pack_pcmpestri.family, pack_pcmpestri.path, pack_pcmpestri.source),
        entry(pack_pcmpestrm.family, pack_pcmpestrm.path, pack_pcmpestrm.source),
        entry(pack_pcmpistri.family, pack_pcmpistri.path, pack_pcmpistri.source),
        entry(pack_pcmpistrm.family, pack_pcmpistrm.path, pack_pcmpistrm.source),
        entry(pack_phminposuw.family, pack_phminposuw.path, pack_phminposuw.source),
        entry(pack_pmovsxbw.family, pack_pmovsxbw.path, pack_pmovsxbw.source),
        entry(pack_pmovsxbd.family, pack_pmovsxbd.path, pack_pmovsxbd.source),
        entry(pack_pmovsxbq.family, pack_pmovsxbq.path, pack_pmovsxbq.source),
        entry(pack_pmovsxwd.family, pack_pmovsxwd.path, pack_pmovsxwd.source),
        entry(pack_pmovsxwq.family, pack_pmovsxwq.path, pack_pmovsxwq.source),
        entry(pack_pmovsxdq.family, pack_pmovsxdq.path, pack_pmovsxdq.source),
        entry(pack_pmovzxbw.family, pack_pmovzxbw.path, pack_pmovzxbw.source),
        entry(pack_pmovzxbd.family, pack_pmovzxbd.path, pack_pmovzxbd.source),
        entry(pack_pmovzxbq.family, pack_pmovzxbq.path, pack_pmovzxbq.source),
        entry(pack_pmovzxwd.family, pack_pmovzxwd.path, pack_pmovzxwd.source),
        entry(pack_pmovzxwq.family, pack_pmovzxwq.path, pack_pmovzxwq.source),
        entry(pack_pmovzxdq.family, pack_pmovzxdq.path, pack_pmovzxdq.source),
        entry(pack_pmuldq.family, pack_pmuldq.path, pack_pmuldq.source),
        entry(pack_pshufb.family, pack_pshufb.path, pack_pshufb.source),
        entry(pack_psignb.family, pack_psignb.path, pack_psignb.source),
        entry(pack_psignw.family, pack_psignw.path, pack_psignw.source),
        entry(pack_psignd.family, pack_psignd.path, pack_psignd.source),
        ...
        entry(permute_vperm2f128.family, permute_vperm2f128.path, permute_vperm2f128.source),
        entry(permute_vperm2i128.family, permute_vperm2i128.path, permute_vperm2i128.source),
        entry(permute_vpermb.family, permute_vpermb.path, permute_vpermb.source),
        entry(permute_vpermd.family, permute_vpermd.path, permute_vpermd.source),
        entry(permute_vpermw.family, permute_vpermw.path, permute_vpermw.source),
        entry(permute_vpermilpd.family, permute_vpermilpd.path, permute_vpermilpd.source),
        entry(permute_vpermilps.family, permute_vpermilps.path, permute_vpermilps.source),
        entry(permute_vpermpd.family, permute_vpermpd.path, permute_vpermpd.source),
        entry(permute_vpermps.family, permute_vpermps.path, permute_vpermps.source),
        entry(permute_vpermq.family, permute_vpermq.path, permute_vpermq.source),
