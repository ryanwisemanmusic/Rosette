...
pub const meta = core.InstructionMathMeta{ .name = "KORQ", .family = "LOGICAL_OR", .path = "LOGICAL_OR/KORQ.inc", .source_table_path = "LOGICAL_OR/KORQ.inc", .target_isa = .x86, .operation = .documented_contract, .register_model = .documented_contract, .flag_model = .documented_contract };
...
test "x86 KORQ documented-contract proofs match table metadata" { try verifyProofs(); }
