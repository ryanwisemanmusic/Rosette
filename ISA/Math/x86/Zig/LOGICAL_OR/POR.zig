...
pub const meta = core.InstructionMathMeta{ .name = "POR", .family = "LOGICAL_OR", .path = "LOGICAL_OR/POR.inc", .source_table_path = "LOGICAL_OR/POR.inc", .target_isa = .x86, .operation = .documented_contract, .register_model = .documented_contract, .flag_model = .documented_contract };
...
test "x86 POR documented-contract proofs match table metadata" { try verifyProofs(); }
