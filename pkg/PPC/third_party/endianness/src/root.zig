//! Source mirror of `third_party/endianness` for the direct PPC route.
//! The direct host is big-endian; Xenon guest vectors remain explicit.
...
test "PPC fixed-width and guest vectors validate" {
...
test "PPC route preserves the source mirror vectors" {
...
test "PPC source mirror fingerprint is stable" {
