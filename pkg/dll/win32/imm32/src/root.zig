...
/// Every name this image imports from IMM32.dll, with the ABI each return value
...
pub const exports = [_]export_contract.Export{
    .{ .name = "ImmAssociateContext", .convention = .handle, .behaviour = .modelled, .zero_is_an_answer = true, .reviewed = true, .note = "NULL means no input context, which is the correct answer with no IME" },
    .{ .name = "ImmGetCandidateListW", .convention = .zero_count, .behaviour = .modelled, .zero_is_an_answer = true, .reviewed = true, .note = "returns bytes copied; zero means nothing to copy, which is normal" },
    .{ .name = "ImmGetCompositionStringW", .convention = .zero_count, .behaviour = .modelled, .zero_is_an_answer = true, .reviewed = true, .note = "returns bytes copied; zero means nothing to copy, which is normal" },
    .{ .name = "ImmGetContext", .convention = .handle, .behaviour = .modelled, .zero_is_an_answer = true, .reviewed = true, .note = "NULL means no input context, which is the correct answer with no IME" },
    .{ .name = "ImmGetIMEFileNameA", .convention = .zero_count, .behaviour = .modelled, .zero_is_an_answer = true, .reviewed = true, .note = "returns bytes copied; zero means nothing to copy, which is normal" },
    .{ .name = "ImmNotifyIME", .convention = .bool32, .behaviour = .modelled, .reviewed = true },
    .{ .name = "ImmReleaseContext", .convention = .bool32, .behaviour = .modelled, .reviewed = true },
    .{ .name = "ImmSetCandidateWindow", .convention = .bool32, .behaviour = .modelled, .reviewed = true },
    .{ .name = "ImmSetCompositionStringW", .convention = .bool32, .behaviour = .modelled, .reviewed = true },
    .{ .name = "ImmSetCompositionWindow", .convention = .bool32, .behaviour = .modelled, .reviewed = true },
};
