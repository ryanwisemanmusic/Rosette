...
/// Every name this image imports from SHLWAPI.dll, with the ABI each return value
...
pub const exports = [_]export_contract.Export{
    .{ .name = "QISearch", .arity = 4, .convention = .hresult, .behaviour = .modelled, .reviewed = true },
};
