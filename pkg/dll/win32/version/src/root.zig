...
/// Every name this image imports from VERSION.dll, with the ABI each return value
...
pub const exports = [_]export_contract.Export{
    .{ .name = "GetFileVersionInfoA", .convention = .bool32, .behaviour = .refused_by_policy, .reviewed = true, .note = "Rosetta owns this ABI and returns the documented unavailable-capability value on macOS." },
    .{ .name = "GetFileVersionInfoSizeA", .arity = 2, .convention = .zero_count, .behaviour = .refused_by_policy, .reviewed = true, .note = "Rosetta owns this ABI and returns the documented unavailable-capability value on macOS." },
    .{ .name = "VerQueryValueA", .convention = .bool32, .behaviour = .refused_by_policy, .reviewed = true, .note = "Rosetta owns this ABI and returns the documented unavailable-capability value on macOS." },
};
