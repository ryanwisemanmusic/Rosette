//! Source-backed ordering facts for Xenia's macOS shader-storage handoff.
...
/// `timeout_continuation` is an explicit Xenia branch outcome. It is never
/// inferred from an elapsed duration or from the absence of a callback.
