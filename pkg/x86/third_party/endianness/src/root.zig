//! Source mirror of `third_party/endianness` for the x86-64 route.
...
test "x86 fixed-width and guest vectors validate" {
...
test "x86 route preserves the source mirror vectors" {
...
test "x86 source mirror fingerprint is stable" {
