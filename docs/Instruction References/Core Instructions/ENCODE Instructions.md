...
F3 0F 38 FA 11:rrr:bbb ENCODEKEY128 r32, r32, <XMM0-2>, <XMM4-6>	A	    V/V	A           ESKLE	            Wrap a 128-bit AES key from XMM0 into a key handle and output handle in XMM0—2.
...
#GP:
    (0) if a reserved bit2 in SRC[31:0] is set
